    ...
    <main className="bg-[#030405] text-[#f5efdd]">
      <PlatformHero
        actions={[
          ...
          { href: "#preview", label: "Ver preview", variant: "secondary" },
          { href: "/equipes", label: "Ranking de equipes", variant: "ghost" },
        ]}
        badges={rankingHeroBadges}
        description="Ranking UR organiza atletas, equipes, níveis, polos, modalidades e engajamento para transformar desempenho em histórico, visibilidade, oportunidades, UR Coins, mídia e recompensas."
        eyebrow="Ranking UR • temporada em formação"
        image={siteImages.attackBlock}
        imagePosition="center 42%"
        metrics={[
          { label: "Base", value: "UR Play alimenta o histórico" },
          { label: "Status", value: "ranking em formação" },
          { label: "Regra", value: "sem atletas, números ou posições reais" },
        ]}
        statusDescription="Dados reais entram após validação oficial de critérios, agenda, temporada e operação."
        statusLabel="produto central"
        statusTitle="Classificação, memória e narrativa competitiva."
        title="Ranking como narrativa da temporada."
      />
