...
const stories: Story[] = [
  {
    ...
    description: "Preparação, pausa, conversa e presença de quadra como parte da narrativa UR.",
    href: "/midia",
    image: siteImages.timeoutTalk,
    meta: "conteúdo oficial após operação validada",
  },
  {
    category: "Ranking",
    title: "A classificação como narrativa de temporada",
    description: "O ranking será aberto depois das primeiras participações validadas.",
    href: "/ranking",
