...
export function RewardArtCard({ icon, title, description, note, className }: RewardArtCardProps) {
  return (
    <URArtCard className={`flex min-h-[190px] flex-col gap-3 p-5 sm:p-6 ${className ?? ""}`}>
      ...
      <p className="text-[15px] leading-7 text-[#8A8A93]" style={{ fontFamily: "'Manrope', system-ui, sans-serif" }}>
        {description}
      </p>
      {note && (
